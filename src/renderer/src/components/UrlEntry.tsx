...
export default function UrlEntry({url, setUrl, setLoaded, setAvailableIcons}): JSX.Element {
	const onUrlChange = (ev: ChangeEvent<HTMLTextAreaElement | HTMLInputElement>) => {
		setLoaded(false);
